"""
Django settings for psigcuclv project.
...
SECRET_KEY = 'django-insecure-ji&q4bas7f50(+bh7^$+62%2iu*d)$zz0^s)@(l#h9$!k!ln*i'
...
ROOT_URLCONF = 'psigcuclv.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR,"psigctpl")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'psigcuclv.wsgi.application'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'psigcmedia')
